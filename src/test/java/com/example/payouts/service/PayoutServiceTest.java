...
class PayoutServiceTest {
    ...
    @Mock
    private PayoutQueueSender payoutQueueSender;
    ...
    void shouldSaveNewPayout() {
        ...
        PayoutService.PayoutCreationResult result = payoutService.createPayout(request, idempotencyKey, clientId);
